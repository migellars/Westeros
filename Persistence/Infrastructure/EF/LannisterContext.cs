...
public class LannisterContext : IdentityDbContext<
    ApplicationUser, ApplicationRole, Guid,
    ApplicationUserClaim, ApplicationUserRole, ApplicationUserLogin,
    ApplicationRoleClaim, ApplicationUserToken>, ILannisterContext
{
    private readonly IHttpContextAccessor _httpContextAccessor = new HttpContextAccessor();

    public LannisterContext(DbContextOptions<LannisterContext> options) : base(options)
    {
    }

    public LannisterContext()
    {
    }
